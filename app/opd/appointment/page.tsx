...
const AppointmentPage = () => {
  ...
  const fillFormWithPatientData = (p: PatientDetail) => {
    ...
    setValue("ageUnit", p.age_unit || "year", { shouldValidate: true })
  ...
  const updateModalityField = (index: number, key: keyof ModalitySelection, value: any) => {
                                      ...
                                      >
                                        <SelectTrigger
                                          className={`h-9 text-sm ${
                                            errors.modalities?.[index]?.doctor ? "border-red-500" : ""
                                          }`}
                                        >
                                      ...
                                      <>
                                        <div className="space-y-2">
                                          ...
                                          >
                                            ...
                                            <SelectContent>
                                              {Array.from(new Set(doctors.flatMap((d) => d.specialist))).map((spec) => (
