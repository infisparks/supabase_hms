    ...
    const fetchAppointmentForEdit = async () => {
      ...
      try {
        ...
        if (data) {
          ...
          setValue("ageUnit", data.patient_detail.age_unit || "year", { shouldValidate: true })
          ...
          form.setValue("modalities", data.service_info || [])
          setActiveTab("book")
                                        ...
                                        <Controller
                                          ...
                                          render={({ field }) => (
                                            <Select
                                              onValueChange={(value) => {
                                                field.onChange(value)
                                                updateModality(index, { specialist: value })
                                              }}
                                              value={field.value || ""}
                                            >
