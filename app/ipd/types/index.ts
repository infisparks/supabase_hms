...
export interface IFormInput {
  ...
  onlineAmount?: number
  discount?: number
  doctor?: string // This is for overall consulting doctor on the form, NOT per-modality doctor
  specialist?: string
  referredBy?: string
...
// ... rest of types.ts remain the same ...
...
export interface Doctor {
  ...
  department: string
  specialist: string[]
  charges: { // Matches Supabase JSONB structure
...
export interface OPDRegistration {
  ...
  payment_info: { // JSONB object of payment details
    paymentMethod: "cash" | "online" | "mixed" | "card-credit" | "card-debit";
    totalCharges: number;
    discount: number;
    totalPaid: number;
